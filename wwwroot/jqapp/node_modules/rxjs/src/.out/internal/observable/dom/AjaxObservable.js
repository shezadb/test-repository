...
var mapResponse = (0, map_1.map)(function (x, index) { return x.response; });
    ...
    AjaxSubscriber.prototype.serializeBody = function (body, contentType) {
        ...
        switch (contentType) {
            case 'application/x-www-form-urlencoded':
                return Object.keys(body).map(function (key) { return "".concat(encodeURIComponent(key), "=").concat(encodeURIComponent(body[key])); }).join('&');
